Tools:
  ...
  - Database of your choosing for JasperReports Server Pro (PostgreSQL was 
    used for development of this project)
  - Database of your choosing for Drupal (PostgreSQL was used for 
    development of this project)

Setup:
  - Project directory should be in an apache2 hosted directory
  - Take sql dump in project (drupal_database_dump.sql) and import it into 
    the database connected with the drupal app that is included with this project
  ...
  - Upload the reports "embedded_reports.zip"
