...
class Organization {
		...
		$tenantUri = null)
	{
		...
		$this->parentId = ($parentId !== null) ? (string) $parentId : null;
		$this->tenantName = ($tenantName !== null) ? (string) $tenantName : null;
		$this->theme = ($theme !== null) ? (string) $theme : null;
		$this->tenantDesc = ($tenantDesc !== null) ? (string) $tenantDesc : null;
		$this->tenantFolderUri = ($tenantFolderUri !== null) ? (string) $tenantFolderUri : null;
		$this->tenantNote = ($tenantNote !== null) ? (string) $tenantNote : null;
		$this->tenantUri = ($tenantUri !== null) ? (string) $tenantUri : null;
